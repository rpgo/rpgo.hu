				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{route('user.store')}}">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">@lang('user.form.name')</label>
							<div class="col-md-6">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">@lang('user.create.password_confirmation')</label>
							<div class="col-md-6">

    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <p><a href="{{route('user.create')}}" class="btn btn-primary btn-large">Mindig ilyen játékra vágytam!</a></p>
            </div>
            <div class="col-sm-4">
                <h2>Mesélőknek</h2>
                ...
                <p><a href="{{route('user.create')}}" class="btn btn-primary btn-large">Végre megvalósíthatom a kalandom!</a></p>
            </div>
            <div class="col-sm-4">
                ...
                <p><a href="{{route('user.create')}}" class="btn btn-primary btn-large">A világomnak itt a helye!</a></p>
            </div>
        </div>
    </div>
@endsection
